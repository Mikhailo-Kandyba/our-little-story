 ...
 * CONTACT_URL — посилання «Написати мені»; заміни YOUR_USERNAME на свій Telegram.
 */

export const girlName = 'Настя';
export const authorName = 'Міша';

export const CONTACT_URL = 'https://t.me/mykhailo_kd';
...
export const story = {
  ...
  paragraphs: [
    'Цю сторінку я задумав ще тоді, коли між нами все було зовсім інакше. Хотів зробити тобі сюрприз, який ти точно не очікувала.',
    'З того часу багато чого змінилося. Але бажання подарувати тобі цю маленьку частинку нашої історії нікуди не зникло.'
  ],
  note: 'Адже те, що було справжнім, заслуговує залишитися в памʼяті.'
};
...
export const message = {
  ...
  paragraphs: [
    'Якщо ти вже дійшла до цього моменту, то, мабуть, зрозуміла, що я трохи заморочився. Хоча кого я обманюю. Дуже заморочився. :)',
    'Мені просто захотілося ще раз нагадати тобі про наші маленькі пригоди, смішні ситуації, обійми, поцілунки й ті моменти, коли ми були по-справжньому щасливі.',
    'Можливо, ти щось уже забула. А можливо, памʼятаєш навіть більше, ніж я.',
    'Тому пропоную тобі ненадовго повернутися в нашу маленьку історію. ❤️'
  ]
};
...
export const closing = {
  title: 'Дякую, що додивилась до кінця. ❤️',
  paragraphs: [
    'Є стільки всього, що мені хотілося б тобі сказати. І, мабуть, навіть цілої сторінки не вистачить, щоб передати все, що я відчуваю.',
    'Ти досі в моїх думках. Щодня. Я переглядаю наші фотографії, згадую твою усмішку, твій голос, наші обійми, поцілунки й ті звичайні дні, коли мені було так добре просто від того, що ти поруч.',
    'Знаєш, найскладніше в цій сторінці було не написати код і не придумати, як усе красиво оформити. Найскладніше було закінчувати її вже тоді, коли ми були не разом.',
    'Я відкривав наші фотографії, згадував усе, що між нами було, і часом просто не міг продовжувати. Мене накривали спогади, і я знову й знову повертався думками до тебе.',
    'Але мені дуже хотілося, щоб ти все-таки побачила цей маленький світ, який я створював для тебе.',
    'Я досі тебе кохаю. Дуже сильно. Мені й зараз хочеться бачити тебе, чути твій голос, дізнаватися, як минув твій день, чути твій сміх і просто міцно обіймати тебе.',
    'Я не знаю, що чекає на нас попереду. Але якщо колись ти захочеш знову мене побачити, я буду дуже радий.',
    'І незалежно від того, як складеться наше життя, я завжди з теплом згадуватиму тебе й усе, що між нами було.'
  ],
  finale: 'Я досі тебе кохаю. І ти назавжди залишишся в моєму серці.',
...
/** Спільне фото з Карпат для 5-го етапу гри (конверт). */
export const CARPATHIANS_PHOTO = 'img/memories/memory-19.jpeg';

export const gameSection = {
  eyebrow: ' ',
  heading: 'У мене є для тебе маленька гра 💗',
  lead: 'Пʼять розділів. Пʼять фрагментів серця. Одна спільна історія.',
  startPrompt: 'Готова перевірити, наскільки добре ти памʼятаєш нашу історію? ❤️',
...
export const gameContent = {
  ...
  maze: {
    ...
    objects: {
      ...
      note: {
        icon: '💌',
        label: 'Нотатка',
        text: 'Твої очі, твоя усмішка, твій сміх. Усе це я так сильно люблю'
      },
      memory: {
        icon: '✨',
        label: 'Спогад',
        text: 'Деякі миті з тобою хочеться прожити ще раз'
      },
      music: {
        icon: '🎵',
        label: 'Музика',
  ...
  // --- Chapter 5: envelope with Carpathians photo ---
  hidden: {
    title: 'Для тебе є ще дещо... 💌',
    subtitle: 'Натисни на конверт. Усередині на тебе чекає маленький спогад.',
    hint: 'Натисни, щоб відкрити ❤️',
    caption: 'Є моменти, які хочеться прожити ще раз. ❤️',
    continueButton: 'Продовжити ❤️',
    ariaLabel: 'Відкрити конверт зі спогадом',
    photo: CARPATHIANS_PHOTO,
    photoAlt: 'Ми разом у Карпатах'
  },
  ...
  finale: {
    ...
    notifyNote: 'Твоя відповідь прийде мені в повідомлення 💌',
